...
int F3Menu(entity_t* player, Tigr* screen, chunkArray_t* loadedChunks){
    char floatXDisplay[25], floatYDisplay[25], intXDisplay[25], intYDisplay[25], healthDisplay[25], chunkXDisplay[25], chunkYDisplay[25], xInChunkDisplay[25], yInChunkDisplay[25], pixelXDisplay[25], pixelYDisplay[25], biomeDisplay[25];
    ...
    snprintf(biomeDisplay, 25, "Biome: %d", loadedChunks->chunkArray[loadedChunks->width / 2][loadedChunks->height / 2].biome);
    ...
    tigrPrint(screen, tfont, 0, 350, tigrRGB(255, 255, 255), biomeDisplay);
}
